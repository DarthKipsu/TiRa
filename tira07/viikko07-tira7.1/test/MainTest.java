...
public class MainTest {
    public void pieniTesti(int[] luvut, int x, boolean tulos) {
        ...
        boolean uusi = Main.etsiSumma(luvut, x);
        if (tulos) {
    ...
    public void pienet() {
        ...
        pieniTesti(new int[] {1, 5, 2, 2, 2}, 1, false);
        pieniTesti(new int[] {1, 5, 2, 2, 2}, 2, false);
        pieniTesti(new int[] {1, 5, 2, 2, 2}, 3, true);
        pieniTesti(new int[] {1, 5, 2, 2, 2}, 4, true);
        pieniTesti(new int[] {1, 5, 2, 2, 2}, 5, false);
        pieniTesti(new int[] {1, 5, 2, 2, 2}, 6, true);
        pieniTesti(new int[] {1, 5, 2, 2, 2}, 7, true);
        pieniTesti(new int[] {1, 5, 2, 2, 2}, 8, false);
        pieniTesti(new int[] {1, 5, 2, 2, 2}, 9, false);
        pieniTesti(new int[] {1, 5, 2, 2, 2}, 10, false);
        pieniTesti(new int[] {1, 5, 2, 2, 2}, 11, false);
        pieniTesti(new int[] {1, 5, 2, 2, 2}, 12, false);
    }    
